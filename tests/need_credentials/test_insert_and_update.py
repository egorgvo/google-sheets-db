...
class ActiveFieldTests(TestCase):
    ...
    def test_insert(self):
        ...
        pk = instance.pk
        data = Лист1.get_row_with_pk(pk)
        self.assertListEqual([str(pk), 'Name', 'Surname'], data)
        ...
        # Check new values
        data = Лист1.get_row_with_pk(pk)
        self.assertListEqual([str(pk), 'Петр', 'Васильев'], data)
    ...
    def test_save(self):
        ...
        # Check new values
        data = Лист1.get_row_with_pk(instance.pk)
        self.assertListEqual([str(instance.pk), 'Name', 'Surname'], data)
